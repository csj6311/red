    ...
    this.readData_process__2 = function ( data ) {
        ...
        return new Promise( function ( resolve, reject ) {
            ...
            var data_group_select = function ( db, callback ) {
                db.collection( 'redgoods' ).aggregate( [ { $group : { _id : "$prd_id" } } ], { allowDiskUse : true } ).toArray( function ( err, docs ) {
        ...
        return new Promise( function ( resolve, reject ) {
            ...
            var data_select = function () {
                ...
                var dataSelect = function ( db, callback ) {
                    ...
                    db.collection( 'redgoods' ).find( { prd_id : t.data2[ t.loop1_idx ] } ).toArray( function ( err, docs ) {
